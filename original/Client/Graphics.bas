...
On Error Resume Next
'*****************************************************************
'Draw BackBuffer to PrimarySurface
'*****************************************************************
Dim fx As DDBLTFX
Dim SourceRect As RECT
...
For y = minY To maxY
    ...
    For x = minX To maxX
        ...
        If InMapBounds(x, y) Then
            ...
            'Layer 3 **********************************
            If MapData(x, y).graphic(3).GrhIndex > 0 And Raining = 1 Then
            ...
            If MapData(x, y).CharIndex > 0 Then
                ...
                If TempChar.MoveOffset.x <> 0 Then
                        ...
                        TempChar.weaponanim.WeaponWalk(TempChar.Heading).Started = 1
                        TempChar.shieldanim.ShieldWalk(TempChar.Heading).Started = 1
                ...
                If Moved = 0 And TempChar.Moving = 1 Then
                    ...
                    TempChar.weaponanim.WeaponWalk(TempChar.Heading).FrameCounter = 1
                    TempChar.weaponanim.WeaponWalk(TempChar.Heading).Started = 0
                    TempChar.shieldanim.ShieldWalk(TempChar.Heading).FrameCounter = 1
                    TempChar.shieldanim.ShieldWalk(TempChar.Heading).Started = 0
                ...
                'Draw Shield In Hands
                Call DDrawTransGrhtoSurface(BackBufferSurface, TempChar.shieldanim.ShieldWalk(TempChar.Heading), (PixelPos(ScreenX) + PixelOffsetXTemp), PixelPos(ScreenY) + PixelOffsetYTemp, 1, 1)
                'Draw Weapon In Hands
                Call DDrawTransGrhtoSurface(BackBufferSurface, TempChar.weaponanim.WeaponWalk(TempChar.Heading), (PixelPos(ScreenX) + PixelOffsetXTemp), PixelPos(ScreenY) + PixelOffsetYTemp, 1, 1)
